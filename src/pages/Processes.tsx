...
PM cập nhật tiến độ của từng bước qua thanh trượt (%) hoặc nút tăng giảm nhanh (-10 / +10). Tiến độ tổng thể của dự án được tính tự động từ trung bình cộng của 7 bước và lưu realtime lên Supabase Cloud.
